    ...
    <div className='min-h-screen flex items-center justify-center bg-ds-section font-body p-4 sm:p-8'>
      <div className="w-full max-w-5xl mx-auto flex flex-col lg:flex-row shadow-2xl rounded-[24px] overflow-hidden border border-ds-border">
        ...
        <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 bg-ds-page relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#3B5FE3] opacity-[0.05] rounded-full blur-3xl transform -translate-x-1/3 translate-y-1/3"></div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-16 bg-white relative">
          <div className="w-full max-w-sm">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className='w-full px-6 py-4 rounded-full flex justify-center items-center gap-3 bg-white border border-gray-200 text-ds-text font-semibold font-heading text-base shadow-sm hover:shadow-md hover:bg-gray-50 transition-all'
            >
              <FcGoogle size={24} />
            ...
            <div className="mt-12 text-center border-t border-ds-border pt-8">
              <a href="/" className="text-sm font-semibold font-heading text-ds-accent hover:text-[#3DBFB4] transition-colors">
                &larr; Back to Home
              </a>
            </div>
